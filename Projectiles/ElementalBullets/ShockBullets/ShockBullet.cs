...
{
	public class ShockBullet : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			var dustIndex = Dust.NewDust(projectile.oldPosition, 10, 10, DustID.BlueTorch, projectile.oldVelocity.X, projectile.oldVelocity.Y, Scale: 0.8f);
