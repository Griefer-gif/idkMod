...
{
	public class Harold2 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			if(timeLeft == 0)
            {
				...
				Projectile.NewProjectile(projectile.oldPosition, speed, ModContent.ProjectileType<HaroldEnd>(), projectile.damage, 0, 0);
				Projectile.NewProjectile(projectile.oldPosition, speed2, ModContent.ProjectileType<HaroldEnd>(), projectile.damage, 0, 0);
