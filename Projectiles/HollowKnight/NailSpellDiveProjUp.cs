...
{
	class NailSpellDiveProjUP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Dive upgrade");     //The English name of the projectile
        ...
        {
			Projectile.NewProjectile(projectile.Center, new Vector2(0, 0), ModContent.ProjectileType<NailSpellDiveProjUPExplosion>(), projectile.damage * 5, 10, projectile.owner);
